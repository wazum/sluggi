...
trait SlugElementTrait
{
    ...
    private function buildRenderContext(array $parameterArray): array
    {
        ...
        $context = [
            ...
            'slugPending' => $table === 'pages' && $this->slugLockService->isSlugGenerationPending($row),
    ...
    private function getLabels(): array
    {
        ...
        return [
            ...
            'conflict.button.keepCurrent' => $languageService->sL($prefix . 'conflict.button.keepCurrent'),
            'conflict.button.useSuggestion' => $languageService->sL($prefix . 'conflict.button.useSuggestion'),
            'conflict.suggestionApplied.title' => $languageService->sL($prefix . 'conflict.suggestionApplied.title'),
            'conflict.suggestionApplied.message' => $languageService->sL($prefix . 'conflict.suggestionApplied.message'),
            'conflict.syncDisabled.title' => $languageService->sL($prefix . 'conflict.syncDisabled.title'),
            'conflict.syncDisabled.message' => $languageService->sL($prefix . 'conflict.syncDisabled.message'),
            ...
            'restriction.slugPending' => $languageService->sL($prefix . 'restriction.slugPending'),
            'pendingLockModal.title' => $languageService->sL($prefix . 'pendingLockModal.title'),
            'pendingLockModal.message' => $languageService->sL($prefix . 'pendingLockModal.message'),
            'pendingLockModal.button.cancel' => $languageService->sL($prefix . 'pendingLockModal.button.cancel'),
            'pendingLockModal.button.confirm' => $languageService->sL($prefix . 'pendingLockModal.button.confirm'),
            ...
            'sourceConfirm.title' => $languageService->sL($prefix . 'sourceConfirm.title'),
            'prefixMismatch.cannotRegenerate.disableSync' => $languageService->sL($prefix . 'prefixMismatch.cannotRegenerate.disableSync'),
            'prefixMismatch.cannotRegenerate.lock' => $languageService->sL($prefix . 'prefixMismatch.cannotRegenerate.lock'),
            'prefixMismatch.cannotRegenerate.askAdmin' => $languageService->sL($prefix . 'prefixMismatch.cannotRegenerate.askAdmin'),
