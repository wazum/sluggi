...
{
    protected int $redirectForceHttps;

    protected int $redirectRespectQueryParameters;

    protected int $redirectKeepQueryParameters;
    ...
    protected function getVariant(string $basePath, string $slug, int $languageId, int $pageId): ?string
    {
        ...
        if (($generatedPath !== $slug) && false !== strpos($generatedPath, $slug)) {
